...
/// Are we in floonet?
/// We are in mainnet if this is false (note production_mode may be false for testing).
/// By default we are in mainnet.
///
/// Note: We do *not* want to introduce is_mainnet() as this would involve conditional
/// mainnet logic and we want to avoid that for testing purposes.
///
